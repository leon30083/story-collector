...
from src.integration.mcp_notion_integration import MCPNotionIntegration

def test_mcp_notion_connection():
    """测试 MCP Notion 连接"""
    print("开始测试 MCP Notion 集成...")
    
    # 初始化 MCP Notion 集成
    notion = MCPNotionIntegration()
